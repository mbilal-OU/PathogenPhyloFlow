...
rows_html = "".join(
    ...
    f"<td>{html.escape(row.get('host', ''))}</td>"
    "</tr>"
...
<section><h2>Samples</h2><table><thead><tr><th>Sample</th><th>Date</th><th>Location</th><th>Host</th></tr></thead><tbody>{rows_html}</tbody></table></section>
